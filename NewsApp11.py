...
class NewsApp:
   def __init_subclass__(self,app):
       self.app = app
       ...
       # =====variables=====
       self.NewsCatButton = []
       self.newCat = ["general","entertainment","business","health","science","technology"]
       ...
       newsTitle = Label(F2,text="NewsArea",bg=light_blue,fg=font_color,bd=7,relief=GROOVE,font=('roboto slab',20,'bold').pack(fill=Y))
       ...
       self.b2.place(x=0,y=625,relwidth=1,relheigh=0.1)
...
def NewsArea(self, event):
        ...
        try:
            ...
            messagebox.showerror('ERROR',"Sorry can't connect to internet or some issues with newsapp :")
